...
namespace SheeEngine
{
	...
	public:
		...
		// flip y axis (picture coords.y is oppsite) 
		void imageFlipVertical(bool value);

		void SetTexture2DUnit(TextureUnit unit, unsigned int ID);
		void SetTexture3DUnit(TextureUnit unit, unsigned int ID);
